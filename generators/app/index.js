...
module.exports = class extends BaseGenerator {
    get initializing() {
        return {
            ...
            displayLogo() {
                ...
                this.log(`\nWelcome to the ${chalk.bold.yellow('JHipster Xiges sample to add a page to the project')} generator! ${chalk.yellow(`v${packageJson.version}\n`)}`);
            },
            checkJhipster() {
    ...
    get prompting() {
        return {
            ...
            questionOne: mainPrompter.askQUestionOne,
            questionTwo: mainPrompter.askQuestionTwo,
            questionThree: mainPrompter.askQuestionThree,
            questionFour: mainPrompter.askQuestionFour
